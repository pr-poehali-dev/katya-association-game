...
const QUESTIONS: Question[] = [
  {
    id: 1,
    question: "Назовите что делают женщины в свой день рождения",
    emoji: "🎂",
    strikes: 0,
    completed: false,
    answers: [
      { text: "Фотографируются", points: 42, revealed: false },
      { text: "Открывают подарки", points: 28, revealed: false },
      { text: "Загадывают желание", points: 15, revealed: false },
      { text: "Плачут от счастья", points: 8, revealed: false },
      { text: "Звонят родителям", points: 7, revealed: false },
    ],
  },
  {
    id: 2,
    question: "Что Катя делает лучше всего?",
    emoji: "⭐",
    strikes: 0,
    completed: false,
    answers: [
      { text: "Улыбается", points: 45, revealed: false },
      { text: "Поднимает настроение", points: 25, revealed: false },
      { text: "Дружит", points: 18, revealed: false },
      { text: "Придумывает идеи", points: 8, revealed: false },
      { text: "Танцевать", points: 4, revealed: false },
    ],
  },
  {
    id: 3,
    question: "Что носит именинница на вечеринке?",
    emoji: "👑",
    strikes: 0,
    completed: false,
    answers: [
      { text: "Красивое платье", points: 50, revealed: false },
      { text: "Корону именинницы", points: 22, revealed: false },
      { text: "Яркий макияж", points: 15, revealed: false },
      { text: "Каблуки", points: 9, revealed: false },
      { text: "Блёстки", points: 4, revealed: false },
    ],
  },
  {
    id: 4,
    question: "Назовите тост за именинницу",
    emoji: "🥂",
    strikes: 0,
    completed: false,
    answers: [
      { text: "За счастье!", points: 38, revealed: false },
      { text: "За любовь!", points: 27, revealed: false },
      { text: "За здоровье!", points: 20, revealed: false },
      { text: "За мечты!", points: 10, revealed: false },
      { text: "За друзей!", points: 5, revealed: false },
    ],
  },
];
